...
- EPIC-006 Pool Locking and Audit Trail: Partial (lock + prerequisites enforcement done; audit log pending)
...
- Pool locking prerequisites are enforced on the lock endpoint; audit log is not implemented.
